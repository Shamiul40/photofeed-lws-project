        ...
        <div className="mt-6">
          ...
          <div className="flex justify-between items-center mb-3">
            ...
            <div className="flex items-center gap-3">
              <Image className="size-12 lg:size-14 rounded-full border" src="https://i.pravatar.cc/150?Image=53" alt="avatar" />
            ...
            <button className="flex items-center gap-1.5 text-black/60 text-xs xl:text-sm">
              <Image src="./assets/icons/follow.svg" alt="" className="w-5 h-5" />
              Follow
            </button>
          </div>
          {/* <!-- author bio --> */}
        ...
        <div className="mt-6">
          <div className="flex items-stretch gap-3">
            <button
              ...
              <Image src="./assets/icons/heart.svg" alt="" className="w-5 h-5" />
              100
            </button>
            <button
              className="flex-1 border py-1.5 rounded text-xs lg:text-sm flex items-center justify-center text-center gap-1.5 font-bold hover:bg-yellow-400">
              <Image src="./assets/icons/save.svg" alt="" className="w-5 h-5" />
              Save
            </button>
            <button
              className="flex-1 border py-1.5 rounded text-xs lg:text-sm flex items-center justify-center text-center gap-1.5 font-bold hover:bg-yellow-400">
              <Image src="./assets/icons/share.svg" alt="" className="w-5 h-5" />
